...
table_name = 'BatchGetRowExamplepmwsfsdw'
...
def batch_get_row(ots_client):
    ...
    request.add(TableInBatchGetRowItem(table_name, rows_to_get, columns_to_get, cond))
    request.add(TableInBatchGetRowItem('notExistTable', rows_to_get, columns_to_get, cond))
